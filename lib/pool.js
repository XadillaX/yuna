 ...
 * @param {Function} callback the callback function
 */
IllyriaPool.prototype.send = function(module, method, params, callback) {
    var self = this;
    var callback = emptyCallback;
    var _argv = Array.prototype.slice.call(arguments);
    if(typeof _argv[_argv.length - 1] === "function") {
        callback = _argv[_argv.length - 1];
        _argv.pop();
    }
    ...
    async.waterfall([
        ...
        function(client, callback) {
            _argv.push(callback);
            client.send.apply(client, _argv);
        }
    ], callback);
};
